...
export type GetFuzzyPokemonQuery = { __typename?: 'Query', getFuzzyPokemon: Array<{ __typename?: 'Pokemon', weight: number, species: string, sprite: string }> };

export type GetPaginatedPokemonQueryVariables = Exact<{
  offset?: InputMaybe<Scalars['Int']['input']>;
...
export type GetPaginatedPokemonQuery = { __typename?: 'Query', getAllPokemon: Array<{ __typename?: 'Pokemon', weight: number, species: string, sprite: string, baseStats: { __typename?: 'Stats', attack: number, defense: number, hp: number, speed: number } }> };
 ...
 * });
 */
export function useGetFuzzyPokemonQuery(baseOptions: ApolloReactHooks.QueryHookOptions<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>(GetFuzzyPokemonDocument, options);
      }
export function useGetFuzzyPokemonLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>(GetFuzzyPokemonDocument, options);
        }
export function useGetFuzzyPokemonSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>(GetFuzzyPokemonDocument, options);
        }
...
export type GetFuzzyPokemonSuspenseQueryHookResult = ReturnType<typeof useGetFuzzyPokemonSuspenseQuery>;
...
/**
 * __useGetPaginatedPokemonQuery__
 *
 * To run a query within a React component, call `useGetPaginatedPokemonQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPaginatedPokemonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPaginatedPokemonQuery({
 *   variables: {
 ...
 * });
 */
export function useGetPaginatedPokemonQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>(GetPaginatedPokemonDocument, options);
      }
export function useGetPaginatedPokemonLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>(GetPaginatedPokemonDocument, options);
        }
export function useGetPaginatedPokemonSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>(GetPaginatedPokemonDocument, options);
        }
export type GetPaginatedPokemonQueryHookResult = ReturnType<typeof useGetPaginatedPokemonQuery>;
export type GetPaginatedPokemonLazyQueryHookResult = ReturnType<typeof useGetPaginatedPokemonLazyQuery>;
export type GetPaginatedPokemonSuspenseQueryHookResult = ReturnType<typeof useGetPaginatedPokemonSuspenseQuery>;
export type GetPaginatedPokemonQueryResult = Apollo.QueryResult<GetPaginatedPokemonQuery, GetPaginatedPokemonQueryVariables>;
...
export type AbilityKeySpecifier = ('bulbapediaPage' | 'desc' | 'isFieldAbility' | 'isNonstandard' | 'key' | 'name' | 'pokemonThatHaveThisAbility' | 'serebiiPage' | 'shortDesc' | 'smogonPage' | AbilityKeySpecifier)[];
export type AbilityFieldPolicy = {
	...
	pokemonThatHaveThisAbility?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type GenerationalPokemonLearnsetKeySpecifier = ('generation3' | 'generation4' | 'generation5' | 'generation6' | 'generation7' | 'generation8' | GenerationalPokemonLearnsetKeySpecifier)[];
export type GenerationalPokemonLearnsetFieldPolicy = {
	generation3?: FieldPolicy<any> | FieldReadFunction<any>,
	generation4?: FieldPolicy<any> | FieldReadFunction<any>,
	generation5?: FieldPolicy<any> | FieldReadFunction<any>,
	generation6?: FieldPolicy<any> | FieldReadFunction<any>,
	generation7?: FieldPolicy<any> | FieldReadFunction<any>,
	generation8?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type LearnsetLevelUpMoveKeySpecifier = ('generation' | 'level' | 'move' | LearnsetLevelUpMoveKeySpecifier)[];
...
export type LearnsetMoveKeySpecifier = ('generation' | 'move' | LearnsetMoveKeySpecifier)[];
...
export type PokemonFieldPolicy = {
	...
	mythical?: FieldPolicy<any> | FieldReadFunction<any>,
	num?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type PokemonLearnsetKeySpecifier = ('dreamworldMoves' | 'eggMoves' | 'eventMoves' | 'levelUpMoves' | 'tmMoves' | 'tutorMoves' | 'virtualTransferMoves' | PokemonLearnsetKeySpecifier)[];
export type PokemonLearnsetFieldPolicy = {
	dreamworldMoves?: FieldPolicy<any> | FieldReadFunction<any>,
	eggMoves?: FieldPolicy<any> | FieldReadFunction<any>,
	eventMoves?: FieldPolicy<any> | FieldReadFunction<any>,
	levelUpMoves?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type PokemonTypeKeySpecifier = ('matchup' | 'name' | PokemonTypeKeySpecifier)[];
export type PokemonTypeFieldPolicy = {
	matchup?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>
};
export type QueryKeySpecifier = ('getAbility' | 'getAllPokemon' | 'getFuzzyAbility' | 'getFuzzyItem' | 'getFuzzyLearnset' | 'getFuzzyMove' | 'getFuzzyPokemon' | 'getItem' | 'getLearnset' | 'getMove' | 'getPokemon' | 'getPokemonByDexNumber' | 'getTypeMatchup' | QueryKeySpecifier)[];
...
export type TypeEffectivenessKeySpecifier = ('doubleEffectiveTypes' | 'doubleResistedTypes' | 'effectiveTypes' | 'effectlessTypes' | 'normalTypes' | 'resistedTypes' | TypeEffectivenessKeySpecifier)[];
export type TypeEffectivenessFieldPolicy = {
...
export type StrictTypedTypePolicies = {
	...
	GenerationalPokemonLearnset?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | GenerationalPokemonLearnsetKeySpecifier | (() => undefined | GenerationalPokemonLearnsetKeySpecifier),
		fields?: GenerationalPokemonLearnsetFieldPolicy,
	},
	...
	PokemonLearnset?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PokemonLearnsetKeySpecifier | (() => undefined | PokemonLearnsetKeySpecifier),
		fields?: PokemonLearnsetFieldPolicy,
	},
	PokemonType?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PokemonTypeKeySpecifier | (() => undefined | PokemonTypeKeySpecifier),
		fields?: PokemonTypeFieldPolicy,
	},
	...
	TypeEffectiveness?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | TypeEffectivenessKeySpecifier | (() => undefined | TypeEffectivenessKeySpecifier),
		fields?: TypeEffectivenessFieldPolicy,
	},
